...
public class AppTest {
    ...
    public void runTest() throws Exception {
        ...
        FileInputStream fis = new FileInputStream("F:\\SampleJava\\skcet\\simple.xls");
        ...
        WebElement homeLoan = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"root\"]/div[2]/div[2]/a[15]/div/p[1]")));
        homeLoan.click();
        ...
        String amtDetails = driver.findElement(By.xpath("//*[@id=\"root\"]/div[2]/div[1]/div[2]/div[1]/div[1]/div[2]/div/p")).getText();
